...
- **Narrow** (`< 55` cols): two-line content (path + branch on line 1, venv/model on line 2). Compact context line, then the usage limits on subscriptions (no tokens-cost row on API billing).
