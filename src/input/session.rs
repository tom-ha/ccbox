...
pub struct OutputStyle {
    #[serde(
        default = "default_output_style_name",
        deserialize_with = "null_to_default"
    )]
    pub name: String,
}
fn default_output_style_name() -> String {
    "default".to_string()
}
...
mod tests {
    ...
    fn fixture_round_trip() {
        ...
        assert_eq!(
            again.context_window.used_percentage,
