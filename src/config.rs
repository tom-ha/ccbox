...
pub struct Env {
    ...
    pub density: Density,
    /// Inline (default) or board kanban for the task row.
...
mod tests {
    ...
    #[test]
    fn tasks_view_default_is_inline() {
        assert_eq!(TasksView::default(), TasksView::Inline);
    }
