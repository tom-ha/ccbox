...
mod tests {
    ...
    #[test]
    fn model_key_recognises_opus() { assert_eq!(model_key("claude-opus-4-7"), ModelKind::Opus); }
    #[test] fn model_key_recognises_sonnet() { assert_eq!(model_key("claude-sonnet-4-6"), ModelKind::Sonnet); }
    #[test] fn model_key_recognises_haiku() { assert_eq!(model_key("claude-haiku-4-5"), ModelKind::Haiku); }
    #[test] fn model_key_other_for_unknown() { assert_eq!(model_key("gpt-4o"), ModelKind::Other); }
    #[test] fn model_key_case_insensitive() { assert_eq!(model_key("CLAUDE-OPUS"), ModelKind::Opus); }
